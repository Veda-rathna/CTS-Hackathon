...
This file enables Alembic autogenerate to discover all SQLAlchemy models
by importing ``app.db.base`` which in turn imports every model module.
"""
...
# Import settings to set database URL dynamically
